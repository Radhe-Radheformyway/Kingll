            ...
            if user_to_add not in allowed_user_ids:
                ...
                if set_approval_expiry_date(user_to_add, duration, time_unit):
                    response = (
                        ...
                        "🌟 WELCOME TO THE TOXICPLAYER002 TEAM!\n\n"
...
def available_commands(message):
    commands_message = (
        ...
        "👤 𝗙𝗢𝗥 𝗨𝗦𝗘𝗥 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 👤\n\n"
        "👤 /KILLER = 𝙏𝙊 𝙎𝙄𝙈𝙐𝙇𝘼𝙏𝙀 𝘼 𝘿𝘿𝙊𝙎 𝘼𝙏𝙏𝘼𝘾𝙆 𝙒𝙄𝙏𝙃 𝙋𝙇𝘼𝙉 1 💠\n"
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        command = message.text.split()
        if len(command) == 4:  # Expecting: /KILLER <target> <port> <time>
            target = command[1]
            try:
            ...
            response = "𝗣𝗟𝗔𝗡 𝟭 𝗔𝗧𝗧𝗔𝗖𝗞 𝗗𝗘𝗧𝗔𝗜𝗟𝗦\n\n𝗨𝗦𝗔𝗚𝗘 :- /KILLER <𝗜𝗣> <𝗣𝗢𝗥𝗧> <𝗧𝗜𝗠𝗘>\n𝗘𝗫𝗔𝗠𝗣𝗟𝗘 :- /KILLER 20.0.0 8700 120\n\n𝙊𝙒𝙉𝙀𝙍 :- @TOXICPLAYER002\n\n❗️ USE RESPONSIBLY!"       
        bot.reply_to(message, response)
    else:
...
def broadcast_message(message):
    ...
    if message.from_user.id == 7933339379:  # Replace with your owner ID
        ...
        if broadcast_content:
            ...
            broadcast_text = (
                "📣 THIS MESSAGE IS FROM TOXIC TEAM 👩‍💻\n\n"
